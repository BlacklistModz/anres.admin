...
class Controller {
    ...
    public function handleLogin(){
        ...
        if( !empty($me) ){
            ...
            // if( $this->pathName == 'cms' ){
            //     if( $this->me['role_id'] != 1 ) $this->login();
            // }
            // elseif( $this->pathName == 'student' ){
            //     if( $this->me['role_id'] != 1 && $this->me['role_id'] != 2 ) $this->login();
            // }
        ...
        if( !empty($_POST) && empty($error) ){
            ...
            if( $login_mode=='pin' && $this->format=='json' ){
                ...
                try {
                    ...
                    // if( $this->pathName=='cms' ) $role = 1;
                    // if( $this->pathName=='student' ) $role = 2;
