...
class Users_Model extends Model{
    ...
    public function login($user, $pess, $role){

        $sth = $this->db->prepare("SELECT user_id as id FROM {$this->_objType} WHERE (user_login=:login AND user_pass=:pass AND user_display='enabled' AND user_role_id=:role) OR (user_email=:login AND user_pass=:pass AND user_display='enabled' AND user_role_id=:role)");
